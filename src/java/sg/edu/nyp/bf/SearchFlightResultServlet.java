...
public class SearchFlightResultServlet extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {  
            Date departureDate= (Date) new SimpleDateFormat("yyyy-MM-dd").parse(request.getParameter("departureDate"));
            ...
            Logger.getLogger(SearchFlightResultServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
